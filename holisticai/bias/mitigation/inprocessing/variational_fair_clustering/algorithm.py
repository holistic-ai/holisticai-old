...
from .algorithm_utils._utils  import get_fair_accuracy, get_fair_accuracy_proportional, normalizefea
import pandas as pd
import logging
...
class FairClusteringAlgorithm:
    ...
    def fit(self, X, p_attr, random_state):
        ...
        min_balance, avg_balance = get_fair_accuracy(group_prob, groups_ids, self.fair_clustering.l , self.K)
        fairness_error = get_fair_accuracy_proportional(group_prob, groups_ids, self.fair_clustering.l, self.K)
