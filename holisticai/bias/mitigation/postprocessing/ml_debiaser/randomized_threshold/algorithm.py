import numpy as np
from .algorithm_utils import SGDDebiaser,FullGDDebiaser, RTLogger
...
class RandomizedThresholdAlgorithm:
  ...
  def __init__(self, gamma=1.0, eps=0.0, rho=None, sgd_steps=10_000, full_gradient_epochs=1_000, batch_size=256, verbose=False):
    """
    Instantiate object.
  ...
  def fit(self, y_score, groups_num):
    ...
    for k in range(num_groups):
      ...
      optimizer = FullGDDebiaser(y=y_score[group_k], 
