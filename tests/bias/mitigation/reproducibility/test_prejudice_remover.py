...
def running_without_pipeline():
    ...
    inprocessing_model = PrejudiceRemover(maxiter=100, fit_intercept=True, verbose=1, print_interval=1).transform_estimator()
...
def running_with_pipeline():
    ...
    inprocessing_model = PrejudiceRemover(init_type='StandarLR', maxiter=100, fit_intercept=True, verbose=1, print_interval=1).transform_estimator()
