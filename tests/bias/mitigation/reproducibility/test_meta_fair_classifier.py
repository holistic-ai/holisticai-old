...
def running_without_pipeline():
    ...
    inprocessing_model = MetaFairClassifier(constraint='StatisticalRate', verbose=1).transform_estimator()
...
def running_with_pipeline():
    inprocessing_model = MetaFairClassifier(constraint='FalseDiscovery', verbose=1).transform_estimator()
