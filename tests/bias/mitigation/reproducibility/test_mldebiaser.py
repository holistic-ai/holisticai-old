...
from holisticai.bias.metrics import multiclass_bias_metrics,classification_bias_metrics
...
def running_without_pipeline_multiclass():
    ...
    sens = SensitiveGroups().fit_transform(np.stack([group_a, group_b], axis=1), convert_numeric=True)
